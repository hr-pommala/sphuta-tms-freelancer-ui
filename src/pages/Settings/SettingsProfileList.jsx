...
const SettingsProfileList = () => {
  ...
  const fetchProfiles = async () => {
    ...
    try {
      ...
      setProfiles([]);
      setFiltered([]);
      setAlertState({ open: true, title: "Error", message: "Failed to load profiles", onClose: null });
    } finally {
      setLoading(false);
    }
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setAlertState({ open: true, title: "Deleted", message: `${toDeleteUserId} profile deleted`, onClose: null });
    } catch (err) {
      console.error("Delete failed", err);
      setAlertState({ open: true, title: "Error", message: "Delete failed. See console for details.", onClose: null });
    } finally {
